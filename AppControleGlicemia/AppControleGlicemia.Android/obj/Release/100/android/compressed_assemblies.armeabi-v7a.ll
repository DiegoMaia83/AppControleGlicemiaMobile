...
@__CompressedAssemblyDescriptor_data_4 = internal global [2051584 x i8] zeroinitializer, align 1
...
@__CompressedAssemblyDescriptor_data_43 = internal global [2058240 x i8] zeroinitializer, align 1
...
@compressed_assembly_descriptors = internal global [44 x %struct.CompressedAssemblyDescriptor] [
	...
	; 4
	%struct.CompressedAssemblyDescriptor {
		i32 2051584, ; uncompressed_file_size
		i8 0, ; loaded
		i8* getelementptr inbounds ([2051584 x i8], [2051584 x i8]* @__CompressedAssemblyDescriptor_data_4, i32 0, i32 0); data
	}, 
	; 5
	%struct.CompressedAssemblyDescriptor {
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i8 0, ; loaded
		i8* getelementptr inbounds ([2058240 x i8], [2058240 x i8]* @__CompressedAssemblyDescriptor_data_43, i32 0, i32 0); data
	}
